...
![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=512]]
...
Checklist details are outlined in _LM-83_, Section 4. Details include but are not limited to:
...
Engineering Society (IES) standard _LM 83-23: Approved Method: IES Spatial Daylight_
_Autonomy (sDA)_ and _Annual Sunlight Exposure (ASE)._
...
approach intentionally differs from the calculation procedure outlined in the _LM-83 standard_ to
...
these spaces is 150 lux in _LM-83_ . These spaces may be identified by reviewing IES
...
are two variations of ASE introduced in the 2023 version of the _LM-83_ standard. ASEnet
