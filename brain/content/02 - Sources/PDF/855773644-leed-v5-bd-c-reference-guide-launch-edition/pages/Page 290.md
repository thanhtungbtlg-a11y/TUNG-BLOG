...
# 855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition - Page 290

![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=290]]

## Extracted Content

Equation 1. COP calculation using energy simulation data

𝐶𝑂𝑃= [T𝑜𝑡𝑎𝑙 𝑎𝑛𝑛𝑢𝑎𝑙 ℎ𝑒𝑎𝑡𝑖𝑛𝑔 𝑔𝑒𝑛𝑒𝑟𝑎𝑡𝑖𝑜𝑛]
...
`o` _ASHRAE 90.1_, Energy Cost Budget Method design energy cost model.

`o` Total System Performance Ratio (TSPR). Simplified model from _ASHRAE 90.1-2022_,
...
_Carbon Projection and Decarbonization Plan_, provided the model inputs include
