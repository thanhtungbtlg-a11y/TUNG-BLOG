...
# 855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition - Page 052

![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=52]]

## Extracted Content

upgrade to energy-efficient equipment, and specify low-carbon materials such as highperformance glazing and supplementary cementitious materials (SCMs) in concrete.
...
|---|---|---|---|
|All|All|All|Evidence of the design charette date, the participants and their<br>roles, and the name and company of the facilitator (e.g., the<br>meeting notes for the design charettes).|
|All|All|All|The OPR defines the goals for synergy across building<br>systems that address decarbonization, quality of life, and<br>ecosystem conservation and restoration, including how<br>success of each goal will be measured.|

##### **REFERENCED STANDARDS**

- Integrative Process (IP) _ANSI Consensus National Standard Guide©_ 2.0 for Design and
Construction of Sustainable Buildings and Communities (2012)
[(usgbc.org/resources/integrative-process-ip-ansi-consensus-national-standard-guide-20-](https://www.usgbc.org/resources/integrative-process-ip-ansi-consensus-national-standard-guide%C2%A9-20-design-and-construction-)
[design-and-construction)](https://www.usgbc.org/resources/integrative-process-ip-ansi-consensus-national-standard-guide%C2%A9-20-design-and-construction-)
