...
# 855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition - Page 326

![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=326]]

## Extracted Content

However, per _ASHRAE 90.1-2022 11.5.2_, the combined contribution of renewable and load
...
measures rather than the full list of measures from _ASHRAE 90.1-2022_, Section 11.5.2.

To assess achievement of incremental energy credits (ECinc):


  - Identify the minimum energy credits required by _ASHRAE 90.1-2022_, Section 11 (ECreq).

  - Determine the total combined energy credits achieved using _AHRAE 90.1-2022_, Section
...
credits required by _ASHRAE 90.1-2022_, Section 11 _._
...
Points are awarded dependent on project scope:
  ...
  - **New Construction** . Earn one point for each 25 incremental _ASHRAE 90.1-2022_,
...
_ASHRAE 90.1-2022_, Section 11 energy credits documented for eligible measures, up to
...
equipment, or loop pumping systems with heat rejection such as water- or groundsource heat pump loops.

  - **Core and Shell projects without central systems** . Earn one point for each nine
incremental _ASHRAE 90.1-2022_, Section 11 energy credits documented for eligible
