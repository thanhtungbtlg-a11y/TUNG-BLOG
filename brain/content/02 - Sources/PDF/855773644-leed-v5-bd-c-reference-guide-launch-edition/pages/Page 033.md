...
# 855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition - Page 033

![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=33]]

## Extracted Content

To support this evaluation, project teams can use tools such as the _FEMA National Risk Index_ _[6]_ _,_
_NOAA Climate Explorer_ _[7]_, or state and municipal hazard mitigation and adaptation plans to
...
**Assessing hazards**
After two priority hazards have been identified, evaluate the impact by specifying the _IPCC_
...
for those with shorter lifespans (20-30 years) should use _Shared Socioeconomic Pathways_
_(SSP) 1–2.6 (Low Emissions Scenario)_ _[8]_ _,_ where less severe climate impacts are expected.
...
vulnerabilities find _SSP5-8.5 (High Emissions Scenario)_ more suitable.
...
potential hazard using historical data and future projections. Teams can refer to the _IPCC_
