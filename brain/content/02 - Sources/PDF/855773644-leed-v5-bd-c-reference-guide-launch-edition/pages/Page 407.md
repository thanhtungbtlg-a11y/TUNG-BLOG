...
# 855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition - Page 407

![[99 - Attachments/Sources/855773644-LEED-v5-BD-C-Reference-Guide-Launch-Edition.pdf#page=407]]
...
_Embodied Carbon_, OR

  - As an output from projects that are attempting the _MRc2: Reduce Embodied Carbon_ .

The intention is that many projects will attempt to earn points from the _MRc2: Reduce Embodied_
_Carbon_ and use the analysis as the documentation for this prerequisite with no further analysis
needed.
