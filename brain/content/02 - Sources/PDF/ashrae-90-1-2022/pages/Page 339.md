...
# ASHRAE-90.1-2022- - Page 339

![[99 - Attachments/Sources/ASHRAE-90.1-2022-.pdf#page=339]]

## Extracted Content

**Table G3.7-1 Performance Rating Method Lighting Power Density Allowances and** 
...
<20 ft in height 0.0375 per foot in total
height
...
>40 ft in height 0.50 + 0.025 per foot in
total height
...
a. In cases where both a common _space_ type and a _building_ -specific _space_ type are listed, the _building_ -specific _space_ type shall apply.
b. For _manual_ -ON or partial-auto-ON _occupancy sensors_, the _occupancy sensor_ reduction factor shall be multiplied by 1.25.
c. For _occupancy sensors_ controlling individual workstation lighting, _occupancy sensor_ reduction factor shall be 30%.
