...
# ASHRAE-90.1-2022- - Page 358

![[99 - Attachments/Sources/ASHRAE-90.1-2022-.pdf#page=358]]
...
|Building Project Energy<br>Source|Units|Carbon Emissions CO<br>2e<br>lb/unit|Site Energy,<br>Btu/unit<br>(see Note 2)|Source Energy,<br>Btu/unit|
|---|---|---|---|---|
...
_**Notes:**_
1. These conversions are based on national averages for the United States and may not be representative for other locations. Jurisdictions that choose to use localized conversion
factors for source _energy_ or carbon emissions should update the corresponding BPF table for consistency using methodology in Section I5. Jurisdictions may add conversion factors
for other _energy_ sources.
2. Site _energy_ only accounts for _energy_ as measured at the building site. It does not account for the _energy_ consumed in the extraction, processing, and transport of primary _energy_,
nor _energy_ consumed in conversion to electricity in power-generation plants.


**Table I5-1 National Average Energy Conversion Factors Used to Calculate BPF**


|Metric|Site Energy|Carbon Emissions CO<br>2e|Source Energy|Energy Cost|
|---|---|---|---|---|
...
|Health care/<br>hospital|0.1250|0.1412|0.1507|0.1544|0.1979|0.1602|0.2319|0.2098|0.2688|0.3262|0.2596|0.3865|0.4926|0.3624|0.5972|0.6143|0.6194|0.8438|1.0747|
