...
# ASHRAE-90.1-2022- - Page 131

![[99 - Attachments/Sources/ASHRAE-90.1-2022-.pdf#page=131]]
...
|---|---|---|---|
|Single package indoor<br>(with or without economizer)|Rating Conditions: A or C|3.5_MRE_|AHRI 910|
|Single package indoor water-cooled<br>(with or without economizer)|Rating Conditions: A, B, or C|3.5_MRE_|3.5_MRE_|
|Single package indoor air-cooled<br>(with or without economizer)|Rating Conditions: A, B, or C|3.5_MRE_|3.5_MRE_|
|Split_system_ indoor air-cooled<br>(with or without economizer)|Rating Conditions: A, B, or C|3.5_MRE_|3.5_MRE_|
...
**Table 6.8.1-14 Electrically Operated DX-DOAS Units, Single-Package and Remote Condenser,** 
**with Energy Recovery—Minimum Efficiency Requirements**

|Equipment Type|Subcategory or Rating Condition|Minimum Efficiency|Test Procedure|
|---|---|---|---|
|Air cooled (dehumidification mode)<br>Air source heat pumps (dehumidification mode)||5.2_ISMRE_<br>5.2_ISMRE_|AHRI 920<br>AHRI 920|
