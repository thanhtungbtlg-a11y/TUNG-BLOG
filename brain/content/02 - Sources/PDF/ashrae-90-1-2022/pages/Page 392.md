...
# ASHRAE-90.1-2022- - Page 392

![[99 - Attachments/Sources/ASHRAE-90.1-2022-.pdf#page=392]]
...
|Building Type<br>Parameter|Hotel<br>(warm) a|Hotel<br>(cold) b|Multifamily<br>(warm) a|Multifamily<br>(cold) b|
|---|---|---|---|---|
|_System_ type|_PTHP_|_PTAC_|_PTHP_|_PTAC_|
...
|_Outdoor air_ _economizer_|No|No|No|No|
...
|_Energy_ recovery ventilator|No|No|No|No|
...
|Heating source|_PTHP_|2 hydronic_boilers_|_PTHP_|2 hydronic_boilers_|
|Heating_COP_ (net of fan)/furnace<br>or_boiler_ _efficiency_|3.10|75%_Et_|3.10|75%_Et_|
...
|HW-loop pumping control|NA|Two-way valves and ride_pump_ <br>curve|NA|Two-way valves and ride_pump_ <br>curve|
