...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/site-banner.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	...
	bio: "Just a boy caught up in dreams and fantasies",
	links: [
		{
			name: "Facebook",
		...
		},
		{
			...
			url: "https://mail.google.com/mail/?view=cm&fs=1&to=thanhtungbtlg%40gmail.com",
		},
	],
};
